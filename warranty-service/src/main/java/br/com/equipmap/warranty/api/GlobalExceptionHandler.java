...
public class GlobalExceptionHandler {
    ...
    ResponseEntity<ProblemResponse> payloadTooLarge(PayloadTooLargeException exception, HttpServletRequest request) {
        return ResponseEntity.status(HttpStatus.PAYLOAD_TOO_LARGE)
                .body(ProblemResponse.of(413, "PAYLOAD_TOO_LARGE", exception.getMessage(), List.of(), traceId(request)));
    }
